...
<html>
  <head>
    <meta charset="utf-8">
    <title>ROPA&APTP | Regístrate</title>
        <link rel="icon" href="view/modulos/img/logo4.ico">
          ...
          <form id="formulario_registro">
            ...
            <fieldset>
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="name" placeholder="Ingresa nombre">
              </div>
              ...
              <div class="input-group">
                <div class="input-group-addon"><i class="fa fa-user"></i></div>
                <input type="text" class="form-control" name="email" placeholder="Ingresa dirección e-mail">
              </div>
              ...
              <div class="input-group">
                ...
                <input type="password" autocomplete="off" class="form-control" name="clave" placeholder="Ingresa contraseña">
              </div>
