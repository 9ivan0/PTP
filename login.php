...
<html>
  <head>
    <meta charset="utf-8">
    <title>ROPA&APTP | Iniciar sesión o regístrase</title>
        ...
        <div class="col-xs-12 col-md-4 col-md-offset-4">
          ...
          <fieldset>
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control" id="user" placeholder="Dirección e-mail">
            </div>
            ...
            <div class="row" id="load" hidden="hidden">
              <div class="col-xs-4 col-xs-offset-4 col-md-2 col-md-offset-5">
                <img src="view/modulos/img/load.gif" width="100%" alt="">
              </div>
