...
<html lang="en">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Open+Sans|Fira+Sans|Muli|Nunito+Sans|Source+Sans+Pro|Rosario|Open+Sans+Condensed:300|Oswald|Muli:300,400&display=swap|Raleway|Fjalla+One|Exo|Pathway+Gothic+One|Sunflower|Alegreya+Sans+SC|Julius+Sans+One|Carrois+Gothic+SC|Homenaje|Metrophobic|Saira+Condensed|Amatic+SC|Kumar+One+Outline|Monoton|Poiret+One|Quicksand|Voltaire|Yanone+Kaffeesatz|Iconsolata|Roboto+Mono|Source+Code+Pro|Hind+Siliguri|Noto+Sans|PT+Sans+Narrow|Inconsolata|B612+Mono|Libre+Franklin|Titillium+Web|Mukta|Nanum+Gotic" rel="stylesheet">
      ...
      <div class="container">
        <div class="row">
          <nav class="navbar navbar-expand-lg navbar-dark">
            <a href="../../" class="navbar-brand order-1 order-lg-2"><img src="img/logo5.png" alt="Logo"></a>
                ...
                <li class="nav-item dropdown megamenu">
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdown-4">
                    <div class="row">
                      ...
                      <div class="col-lg-4">
                        <div class="promo">
                          <span class="image image-overlay" style="background-image: url(img/background-3.jpg)"></span>
              ...
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                  <a data-toggle="modal" data-target="#search" class="nav-link">
                    <span class="search" style="background-image: none;"><svg width="15.5" height="15.5" viewBox="0 0 15.5 15.5">
                    <circle id="lupa" stroke="#D4D4D4" fill="transparent" cx="6.8" cy="6.797" r="5.64"></circle>
                    <path id="lupa" stroke="#D4D4D4" fill="transparent" d="M11.06 11.058l2.81 2.805"></path></svg>
                  </span></a>
                </li>
          ...
          <div class="col">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Sudaderas</li>
              </ol>
            </nav>
          </div>
        </div>
        ...
        <div class="row justify-content-end">
          <div class="col-lg-9">
            <div class="row gutter-2 align-items-end">
              <div class="col-md-6">
                <h1 class="mb-0">Sudaderas</h1>
                <span class="eyebrow">20 productos</span>
              </div>
          ...
          <aside class="col-lg-3 sidebar">
              ...
              <div class="d-lg-block collapse" id="collapse-1">
                ...
                <div class="widget-content">
                  <ul id="page-nav" class="nav flex-column nav-category">
                    <li class="nav-item">
                      <a class="nav-link" data-toggle="collapse" href="#menu-2" role="button" aria-expanded="false" aria-controls="menu-2">Mujer</a>
                    ...
                    <li class="nav-item">
                      <a class="nav-link" data-toggle="collapse" href="#menu-3" role="button" aria-expanded="false" aria-controls="menu-3">Hombre</a>
            ...
            <div class="widget">
              ...
              <div class="d-lg-block collapse" id="collapse-3">
                <span class="widget-title">Talla</span>
                <div class="widget-content">
              ...
              <div class="d-lg-block collapse" id="collapse-4">
                ...
                <div class="widget-content">
                  <div class="btn-group-toggle btn-group-square btn-group-colors" data-toggle="buttons">
                    ...
                    <label class="btn text-black">
                      <input type="checkbox" name="options" id="option5-2">
                    </label>
                    <label class="btn text-orange">
                      <input type="checkbox" name="options" id="option6-2">
                    </label>
                    <label class="btn text-pink">
                      <input type="checkbox" name="options" id="option7-2">
                    </label>
            ...
            <div class="widget">
              ...
              <div class="d-lg-block collapse" id="collapse-5">
                <span class="widget-title">Precio</span>
                <div class="widget-content">
              ...
              <div class="col-6 col-md-4">
                <div class="product">
                  <figure class="product-image">
                    <a href="#!">
                      <img src="img/cazadora_bomper_basica.jpg" alt="Image">
                      <img src="img/cazadora_bomper_basica2.jpg" alt="Image">
                    </a>
                  </figure>
                  <div class="product-meta">
                    <h3 class="product-title"><a href="#!">Cazadora bomper básica </a></h3>
                  ...
                  <figure class="product-image">
                    <div class="owl-carousel" data-nav="true" data-loop="true">
                      <a href="product-masonry.html">
                        <img src="img/product-35.jpg" alt="Image">
                      </a>
                      <a href="product-mansory.html">
                        <img src="img/product-35-2.jpg" alt="Image">
                      </a>
                      <a href="product-mansory.html">
                        <img src="img/product-35-3.jpg" alt="Image">
                      </a>
                    </div>
                  </figure>
                  <div class="product-meta">
                    <h3 class="product-title"><a href="product-masonry.html">Washed Rose Sudadera con capucha</a></h3>
                    <div class="product-price">
                      <span>$82</span>
                      <span class="product-action">
                        <a href="product-masonry.html">Add to cart</a>
                      </span>
                    </div>
                    <a href="#!" class="product-like"></a>
                  </div>
