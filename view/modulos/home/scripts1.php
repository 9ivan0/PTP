...
<script src="modulos/js/vendor.min.js"></script>
<script src="modulos/js/app.js"></script>
<script src="modulos/js/jquery.js"></script>
<script src="modulos/js/sweetalert.min.js"></script>
<script src="modulos/js/operaciones.js"></script>
