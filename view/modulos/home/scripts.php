...
<script src="view/modulos/js/validation.js"></script>
<script src="view/modulos/js/modernizr.js"></script>
<script src="view/modulos/js/vendor.min.js"></script>
<script src="view/modulos/js/app.js"></script>
