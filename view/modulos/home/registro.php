<?php
  ...
  */
  ...
  if(isset($_SESSION['id'])){
    header('location: controller/redire.php');
  }
...
<html>
  <head>
    ...
    <link rel="stylesheet" href="view/modulos/css/bootstrap.min.css">
    <!-- Font Awesome: para los iconos -->
    <link rel="stylesheet" href="view/modulos/css/font-awesome.min.css">
    <!-- Sweet Alert: alertas JavaScript presentables para el usuario (más bonitas que el alert) -->
    <link rel="stylesheet" href="view/modulos/css/sweetalert.css">
    <!-- Estilos personalizados: archivo personalizado 100% real no feik -->
    <link rel="stylesheet" href="view/modulos/css/style.css">
  ...
  <body>
    ...
    <!-- Jquery -->
    <script src="view/modulos/js/jquery.js"></script>
    <!-- Bootstrap js -->
    <script src="view/modulos/js/bootstrap.min.js"></script>
    <!-- SweetAlert js -->
    <script src="view/modulos/js/sweetalert.min.js"></script>
    <!-- Js personalizado -->
    <script src="view/modulos/js/operaciones.js"></script>
  </body>
</html>
